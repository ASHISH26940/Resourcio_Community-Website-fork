...
export interface ApiMarkdownMarkdown extends Schema.CollectionType {
  ...
  attributes: {
    markDown: Attribute.String;
    slug: Attribute.UID<'api::markdown.markdown', 'markDown'>;
    task: Attribute.RichText;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiMediatestingMediatesting extends Schema.CollectionType {
  collectionName: 'mediatestings';
  info: {
    singularName: 'mediatesting';
    pluralName: 'mediatestings';
    displayName: 'mediatesting';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiTestingTesting extends Schema.CollectionType {
  ...
  attributes: {
    ...
    testId: Attribute.UID<'api::testing.testing', 'title'>;
    todayDate: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::mediatesting.mediatesting': ApiMediatestingMediatesting;
